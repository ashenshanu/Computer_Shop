...
<head>
    ...
    <link rel="stylesheet" href="../shopper/css/shopper-main.css">
    <title>Your Shops | Sanakin.lk</title>
</head>
...
//    var_dump($_SESSION['user']);
        ...
        <div class="sec-container">
            <div class="tile-board shops">
                ...
                <div class="shop-tile-table">
                    ...
                    ?>
                                <div class="tile" onclick="location.href='./order_status.php?shopid=<?php echo $shopList[$s][0];?>'">
    ...
    <?php include './logout-confiremation.php'; ?>
    <script src="https://code.jquery.com/jquery-3.6.3.slim.min.js" integrity="sha256-ZwqZIVdD3iXNyGHbSYdsmWP//UBokj2FHAxKuSBKDSo=" crossorigin="anonymous"></script>
    <script src="../js/bootstrap.js"></script>
    <script src="../js/bootstrap.bundle.min.js"></script>
    <script src="../shopper/js/tools.js?v=741"></script>
