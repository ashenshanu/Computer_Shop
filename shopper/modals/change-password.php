        ...
        <div class="modal-content" style="width: 400px">
            ...
            <div class="modal-body" style="width: 100%">
                ...
                <div class="feilds-sec">
                    ...
                    <input type="password" class="t-feild" name="current-password" id="current-password" placeholder="Current Password" >
                    <input type="password" class="t-feild" name="new-password" id="new-password" onkeyup="checkNewPasswordMatch()" placeholder="New Password" >
                    <input type="password" class="t-feild" name="confirm-new-password" id="confirm-new-password" onkeyup="checkNewPasswordMatch()" placeholder="Confirm New Password" >
                   <div id="divCheckPasswordMatch"></div>
                </div>
                <input type="button" class="btn primary" name="update-password" id="update-password" onclick="updatePassword(<?php echo $loggedUser['user_id']?>)" value="Update">
            </div>
...
<!-- $2y$10$ttKPmt/soOe.wFLedOPZ0ewP1S7IsZAGsSd0sGyo0dyCatA5bmeEm -->