<div class="modal fade modal-box update-info-modal" id="update-customer-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                ...
                <div class="feilds-sec">
                    ...
                    <span>
                        ...
                        <select class="t-feild tf2" name="update-gender" id="update-gender" sele >
