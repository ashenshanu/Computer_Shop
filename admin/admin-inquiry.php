...
<head>
    ...
    <title>Inquiries | Sanakin.lk</title>
</head>
...
<body>
            ...
            <div class="table-responsive">
                <table class="table ">
                    ...
                    <tbody>
                        ...
                        if (isset($inquiryList)) {
                            if (count($inquiryList) > 0) {
                                for ($i = 0; $i < count($inquiryList); $i++) {
                        ?>
                                    <tr>
                                        <td>
                                            <p class="text-sm">#<?php echo $inquiryList[$i]["inq_id"] ?></p>
                                        </td>
                                        <td>
                                            <p class="text-sm"><?php echo $inquiryList[$i]["inq_name"] ?></p>
                                        </td>
                                        <td>
                                            <p class="text-sm"><?php echo $inquiryList[$i]["inq_msg"] ?></p>
                                        </td>
                                        <td>
                                            <p class="text-sm"><?php echo $inquiryList[$i]["inq_contact"] ?></p>
                                        </td>
                                        <td>
                                            <p class="text-sm"><?php echo $inquiryList[$i]["inq_email"] ?></p>
                                        </td>
                                        <td>
                                            <p class="text-sm"><?php echo $inquiryList[$i]["create_date"] ?></p>
                                        </td>
                                    </tr>
                        <?php
                                }
    ...
    <script>
        document.getElementById('inquiry').classList.add('selected');
    </script>
